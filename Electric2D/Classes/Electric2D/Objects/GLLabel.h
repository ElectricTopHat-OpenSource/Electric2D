...
public: // Functions
	...
	// Constructor
	// --------------------------------------------------
	GLLabel( NSString * _text=@"", Boolean _staticText=false, CGSize _size = CGSizeMake(64.0f, 32.0f), UITextAlignment _alignment = UITextAlignmentCenter, float _fontSize = 14.0f, NSString * _fontName = @"Arial", CGPoint _center = CGPointMake(20.0f,455.0f) );
...
public:	// Functions
	...
	inline const GLColor & color() const { return m_fontColor; };
	...
	inline void setColor(const GLColor & _color) { m_fontColor.setColor(_color); };
	inline void setColor(const UIColor * _color) { m_fontColor.setColor(_color); };
	
	// access the shadow color variable
	inline const GLColor & shadowColor() const { return m_fontShadowColor; };
	...
	inline void setShadowColor(const GLColor & _color) { m_fontShadowColor.setColor(_color); };
